...
| --- | --- |
| Core client | `paymesh` |
| Providers | `@paymesh/stripe`, `@paymesh/polar` |
...
<Callout type="info">
  The docs below stay anchored to what is actually exported in the repository. Planned providers like AbacatePay, PayPal, and Dodo are treated as planned work, not presented like shipped integrations.
</Callout>
