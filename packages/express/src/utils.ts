...
export interface ExpressRequestWithRawBody extends Request {
	rawBody?: unknown;
}

/**
 * Converts Express headers into a Fetch `Headers` object.
 */
export function headerfy(request: {
...
/**
 * Reads the webhook body from an Express request.
 */
export async function readBody(request: ExpressRequestWithRawBody) {
 ...
 */
export async function createWebhookRequest(request: ExpressRequestWithRawBody) {
