...
/**
 * Minimal SQL executor contract used by the Postgres adapter helpers.
 */
export interface SqlExecutor {
	persistRaw: boolean;
	query<Row = unknown>(query: import('paymesh').CompiledQuery): Promise<Row[]>;
	execute(query: import('paymesh').CompiledQuery): Promise<void>;
}
